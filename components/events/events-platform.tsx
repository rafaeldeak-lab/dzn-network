    ...
    <EventsShell>
      ...
      <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_340px]">
        ...
        <aside className="space-y-5">
          <PremiumLockedCard title="PRO EVENT TOOL" message="Event creation and cross-server matching use your Pro entitlement. Free users keep teaser access." />
  ...
  return (
    <EventsShell>
      ...
      <div className="grid gap-5 xl:grid-cols-[1fr_320px]">
        ...
        <aside className="space-y-5">
          <PremiumLockedCard title="CROSS-SERVER MATCHING" message="Cross-server matching is a Pro platform feature." />
          <div className="rounded-lg border border-white/10 bg-white/[0.035] p-4">
