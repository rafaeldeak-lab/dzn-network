...
assert.match(ownerUiSource, /Platform-owner support view/, "Every connected server must expose a platform-owner support view.");
assert.match(ownerUiSource, /\/api\/owner\/servers\/\$\{encodeURIComponent\(server\.id\)\}/, "Support view must reload the exact selected server through the protected owner endpoint.");
