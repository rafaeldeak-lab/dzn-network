...
const ownerPreviewActivationBlock = dznOwnerConsolePreviewWorkflow.slice(ownerPreviewActivationStart, ownerPreviewResolveD1Start);
...
assert.equal(ownerPreviewActivationVerifyStart < ownerPreviewResolveD1Start, true, "Activation flow must stay separate from full-preview D1 creation.");
