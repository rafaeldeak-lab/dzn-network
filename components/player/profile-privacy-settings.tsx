...
export function PlayerProfilePrivacySettings({ onSaved }: { onSaved?: () => void } = {}) {
  ...
  return (
    <section id="profile-settings" aria-busy={state.status === "loading"} className="scroll-mt-72 rounded-lg border border-cyan-300/25 bg-slate-950/78 p-5 shadow-[0_0_42px_rgba(34,211,238,0.1)] backdrop-blur md:scroll-mt-44">
