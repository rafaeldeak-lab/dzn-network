...
checkIncludes("functions/_lib/nitrado.ts", "fullDownloadFallback", "ADM sample reads can fall back to full download");
checkIncludes("functions/_lib/nitrado.ts", "download_fallback_attempted", "ADM discovery diagnostics expose download fallback attempts");
...
checkIncludes("functions/api/servers/[serverId]/adm-file-discovery/debug.ts", "recordAdmDiscoveryResult", "ADM discovery debug persists newest available/readable state");
