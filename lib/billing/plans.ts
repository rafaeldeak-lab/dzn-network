...
export const BILLING_PLAN_CONFIG: Record<PlanKey, BillingPlanConfig> = {
  ...
  starter: {
    ...
    name: "DZN Starter",
    monthly_price: 4.99,
    stripe_price_env_key: "NEXT_PUBLIC_STRIPE_STARTER_PRICE_ID",
  ...
  pro: {
    ...
    name: "DZN Pro",
    monthly_price: 9.99,
    stripe_price_env_key: "NEXT_PUBLIC_STRIPE_PRO_PRICE_ID",
  ...
  network: {
    ...
    name: "DZN Network",
    monthly_price: 19.99,
    stripe_price_env_key: "NEXT_PUBLIC_STRIPE_NETWORK_PRICE_ID",
  ...
  partner: {
    ...
    name: "DZN Partner",
    monthly_price: 29.99,
    stripe_price_env_key: "NEXT_PUBLIC_STRIPE_PARTNER_PRICE_ID",
