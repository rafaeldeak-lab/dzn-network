          ...
          {links.map((link) => {
            ...
            return (
              <Link
                ...
                className={`inline-flex min-h-11 items-center justify-center rounded-lg px-3 py-2 text-[11px] font-black uppercase transition focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-200 sm:px-4 sm:py-3 sm:text-xs ${
          ...
          <div className="flex flex-wrap gap-2">
            {secondaryLinks.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="inline-flex min-h-10 items-center justify-center rounded-lg border border-white/10 bg-black/30 px-3 py-2 text-[10px] font-black uppercase text-zinc-300 transition hover:border-emerald-300/30 hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-200"
              >
                {link.label}
              </Link>
            ))}
