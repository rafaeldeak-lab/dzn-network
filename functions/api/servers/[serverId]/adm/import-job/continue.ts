import { processNextAdmImportJobChunk } from "../../../../../_lib/adm-sync";
import { getSessionUser } from "../../../../../_lib/db";
import { json, methodNotAllowed, readJson } from "../../../../../_lib/http";
import { requireServerOwnerOrDznAdmin } from "../../../../../_lib/public-cache";
import type { PagesFunction } from "../../../../../_lib/types";

type ContinueAdmImportJobBody = {
  jobId?: string;
};
...
export const onRequestPost: PagesFunction = async ({ request, env, params }) => {
  ...
  try {
    ...
    const body = await readJson<ContinueAdmImportJobBody>(request);
    ...
    return admImportJobError(500, "adm_import_job_continue_failed", "Unable to continue ADM import job.", {
      ...requestDetails,
