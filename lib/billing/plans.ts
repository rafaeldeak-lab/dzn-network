...
export const SUBSCRIPTION_PLAN_PUBLIC_CONTRACT: Record<PurchasablePlanKey, SubscriptionPlanPublicContract> = {
  starter: {
    ...
    marketingLabel: "2-day free trial for eligible accounts",
    ctaLabel: "Choose Starter",
    priceLabel: "£2/month; eligible accounts get a 2-day free trial",
    monthlyPriceGbp: BILLING_PLAN_CONFIG.starter.monthly_price,
    trialDays: 2,
    requiresPaymentMethod: true,
    firstPaymentAmountGbp: 2,
    firstPaymentLabel: "Payment method required. Eligible accounts pay £0 during the two-day trial, then £2/month until cancelled. Cancel before trial expiry to avoid the first payment. Returning accounts must confirm £2 now with no new trial.",
    ...
    trackingGuarantee: "Plans do not change imported stat formulas. Automatic sync needs completed server setup, supported logs and eligible owner access.",
  },
  pro: {
    key: "pro",
    name: BILLING_PLAN_CONFIG.pro.name,
    marketingLabel: "Advanced server-owner tools",
    ...
    firstPaymentLabel: "£10 due when payment is confirmed, then £10/month until cancelled. No free trial.",
    autoRenewsMonthly: true,
    ...
    profileBenefits: ["Advanced owner analytics where data is available", "Enhanced public profile, custom banner and gallery images", "Featured and spotlight rotation eligibility"],
