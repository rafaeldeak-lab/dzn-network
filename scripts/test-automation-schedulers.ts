...
assert.equal(deployWorkflow.includes("schedule?.cron === \"*/5 * * * *\""), true);
assert.equal(deployWorkflow.includes("schedule?.cron_trigger?.cron === \"*/5 * * * *\""), true);
assert.equal(deployWorkflow.includes("schedule?.schedule === \"*/5 * * * *\""), true);
...
assert.equal(deployWorkflow.includes("crons = [\"*/5 * * * *\"]"), true);
