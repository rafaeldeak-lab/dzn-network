...
includesAll(leaderboards, [
  ...
  "leaderboard-ref-topbar",
  "leaderboard-ref-logo-link",
  "leaderboard-ref-logo-box",
  "leaderboard-ref-logo-copy",
  "leaderboard-ref-topbar-links",
  "leaderboard-ref-hero-content",
  "leaderboard-ref-hero-subtitle",
  "leaderboard-ref-hero-updated",
  "leaderboard-ref-stats-row",
...
assert.equal(leaderboards.includes("Add Your Server"), false, "Leaderboards topbar should not render the larger Add Your Server CTA.");
...
includesAll(globals, [
  ...
  ".leaderboard-ref-hero-content",
  ".leaderboard-ref-live-badge",
  ".leaderboard-ref-title",
  ".leaderboard-ref-title-global",
  ".leaderboard-ref-title-purple",
  ".leaderboard-ref-hero-subtitle",
  ".leaderboard-ref-hero-updated",
  ".leaderboard-ref-stats-row",
  ".leaderboard-ref-stats",
