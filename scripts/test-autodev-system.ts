...
assert.equal(postDeployWorkflow.includes("CLOUDFLARE_API_TOKEN"), false);
assert.equal(postDeployWorkflow.includes("CLOUDFLARE_ACCOUNT_ID"), false);
assert.equal(cycleWatchWorkflow.includes("CLOUDFLARE_API_TOKEN"), false);
assert.equal(cycleWatchWorkflow.includes("CLOUDFLARE_ACCOUNT_ID"), false);
