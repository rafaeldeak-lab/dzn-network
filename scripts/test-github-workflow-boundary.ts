...
assert.equal(dznDiscordControlPhase2aProductionRolloutWorkflow.includes("Approved preview run API head_branch"), true);
assert.equal(dznDiscordControlPhase2aProductionRolloutWorkflow.includes("Approved preview run API head_sha"), true);
...
assert.equal(dznDiscordControlPhase2aProductionRolloutWorkflow.includes("checking repository-wide workflow run list for exact run id"), true);
assert.equal(dznDiscordControlPhase2aProductionRolloutWorkflow.includes("actions/runs?per_page=100&page=${page}"), true);
assert.equal(dznDiscordControlPhase2aProductionRolloutWorkflow.includes("Repository workflow run list page"), true);
...
assert.equal(dznDiscordControlPhase2aProductionRolloutWorkflow.includes("Found approved preview run id/workflow/event/head_branch/conclusion"), true);
...
assert.equal(dznDiscordControlPhase2aProductionRolloutWorkflow.includes("actions/runs/${runId}/jobs"), true);
assert.equal(dznDiscordControlPhase2aProductionRolloutWorkflow.includes("actions/jobs/${jobId}/logs"), true);
assert.equal(dznDiscordControlPhase2aProductionRolloutWorkflow.includes("workflow_dispatch was launched with \"Use workflow from: main\""), true);
assert.equal(dznDiscordControlPhase2aProductionRolloutWorkflow.includes("Detected preview input branch"), true);
assert.equal(dznDiscordControlPhase2aProductionRolloutWorkflow.includes("Detected preview tested commit"), true);
assert.equal(dznDiscordControlPhase2aProductionRolloutWorkflow.includes("approved branch HEAD guard"), true);
assert.equal(dznDiscordControlPhase2aProductionRolloutWorkflow.includes("Could not verify approved preview run branch input"), true);
assert.equal(dznDiscordControlPhase2aProductionRolloutWorkflow.includes("Could not verify approved preview run tested commit"), true);
