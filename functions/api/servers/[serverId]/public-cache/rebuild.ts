...
import { rebuildPublicCacheForServer, requireServerOwnerOrDznAdmin } from "../../../../_lib/public-cache";
...
export const onRequestPost: PagesFunction = async ({ request, env, params }) => {
  ...
  return json(await rebuildPublicCacheForServer(env, linkedServerId), {
    headers: {
