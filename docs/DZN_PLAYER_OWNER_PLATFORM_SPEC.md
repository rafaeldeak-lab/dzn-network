...
- DZN Comms/support remains the next queued product area: continue in the safe order of read history, sending contract, reactions, moderation/timeouts, presence counter, support launcher, then the public-DZN-info-only AI support bot.
