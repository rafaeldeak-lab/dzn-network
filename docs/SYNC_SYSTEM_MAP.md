...
- Active jobs are shown as processing, not failed. Bulk ADM Import Summary counts processing files separately and displays current chunk, parsed kills, written kills, joins, disconnects, PlayerList snapshots, and the last job update while polling every few seconds.
