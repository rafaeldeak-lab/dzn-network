...
assert.equal(dznServerLifecycleProductionRolloutWorkflow.includes("28585826007"), true);
assert.equal(dznServerLifecycleProductionRolloutWorkflow.includes("743fbbd6aee2272d70aebd0179423fbf9f6567f3"), true);
