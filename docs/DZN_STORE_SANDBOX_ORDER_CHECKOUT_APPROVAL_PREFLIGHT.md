...
That follow-on ledger schema slice is now delivered in `docs/DZN_STORE_SANDBOX_ORDER_LEDGER_SCHEMA.md` and `migrations/0072_dzn_store_order_ledger_schema.sql`.
